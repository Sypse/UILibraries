...
function Library:CreateWindow(Config, Parent)
	...
	warn("who made these shitty slider calculations?, Fixed by Sypse#6005")
	function WindowInit:CreateTab(Name)
		...
		function TabInit:CreateSection(Name)
			...
			function SectionInit:CreateSlider(Name, Min, Max, Default, Precise, Callback)
				...
				Slider.Slider.Bar.Size = UDim2.new((DefaultLocal - Min)/(Max - Min),0,1,0)
				...
				function SetValue(Value)
					...
					Slider.Slider.Bar.Size = UDim2.new((Value - Min)/(Max - Min),0,1,0)
				...
				Slider.Value.FocusLost:Connect(function()
					...
					Slider.Slider.Bar.Size = UDim2.new(Slider.Value.Text / Max)
